...
<html lang="en">
  ...
  <head>
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                ...
                <div class="main-button">
                    <a href="/reservation/step-one">Book a table</a>
                </div>
            </div>
        </div>
    </div>
   ...
   <!-- ***** Cars Starts ***** -->
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <p>Enjoy a variety of offers with great prices and portions.</p>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <section class="section section-bg" id="call-to-action" style="background-image: url(mages/banner-image-1-1920x500.jpg)">
        <div class="container">
            <div class="row">
    ...
    <!-- Bootstrap -->
    <script src="ajs/popper.js"></script>
